...
INSERT INTO warehouse_orders (id, quantity, book_title, client_name, client_address, client_email, state)
VALUES ('3c759575-7d2f-495d-93c8-6c3e04418eb0', 10, 'Titulo 1', 'Antonio', 'Rua X1', 'x@x.com', 0);
INSERT INTO warehouse_orders (id, quantity, book_title, client_name, client_address, client_email, state, state_date)
